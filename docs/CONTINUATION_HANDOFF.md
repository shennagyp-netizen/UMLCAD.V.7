...
The latest Rust result on `791cc625772f55718ae252e9146a00986ecb4f55` still returned `MaxDepth` for the original 1e-3 angular test at depth 10. Analysis showed that depth is not sufficient for that unit-scale curved surface under the current bounded certificate. Commit `85624426934e29ca11ba814317fdcf73d75b5c74` keeps the production policy unchanged and changes only the success fixture to the established 0.05-radian angular regime already used by the curved-surface tessellation regression, while strengthening the trim test to require preservation of every adaptive boundary UV sample, not only the four corners.

Exact-head Rust and comprehensive E2E/red-team validation for `85624426934e29ca11ba814317fdcf73d75b5c74` are now required.
