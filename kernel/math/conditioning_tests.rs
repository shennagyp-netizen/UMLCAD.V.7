use super::linalg::{rank_evidence, svd, CANONICAL_ILL_COND_THRESHOLD, CANONICAL_RANK_TOL, RankClassification};
...
#[test]
fn condition_below_explicit_threshold_is_well_conditioned() {
...
#[test]
fn condition_above_explicit_threshold_is_ill_conditioned_when_rank_remains_full() {
